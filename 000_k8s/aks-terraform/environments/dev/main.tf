# Data blocks to query Azure subscription and tenant metadata
...
# DATA BLOCK: Fetch Resource Group details after module execution
...
# DATA BLOCK: Fetch Virtual Network details via Data Block
...
# DATA BLOCK: Fetch Subnet details via Data Block
...
# DATA BLOCK: Fetch Log Analytics Workspace via Data Block
...
# DATA BLOCK: Fetch AKS Cluster details (identity, endpoints) via Data Block
